package com.github.afrin14.attendancemarker;
...
public class AppBase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        divisions.add("S1 DATA AND WEB MINING");
        divisions.add("S2 OPERATING SYSTEM");
        divisions.add("S3 INDUSTRIAL INSTRUMENTATION");
        divisions.add("S4 EMBEDDED SYSTEMS");
        divisions.add("S5 CORE JAVA");
        divisions.add("S6 COMPILER DESIGN");
